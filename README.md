...
```
13. Создать класс с [Инкапсуляцией методов и наследованием](https://github.com/Aroptich/FinallyWork09.07.2023/tree/main/Model) по диаграмме
14. Написать [программу](https://github.com/Aroptich/FinallyWork09.07.2023/tree/main/System%20/src), имитирующую работу реестра домашних животных. В программе должен быть реализован следующий функционал:
...
15. Создайте [класс Счетчик](https://github.com/Aroptich/FinallyWork09.07.2023/blob/main/System%20/src/Controller/Counter.java), у которого есть метод add(), увеличивающий̆ значение внутренней̆ int переменной̆ на 1 при нажатии “Завести новое животное” Сделайте так, чтобы с объектом такого типа можно было работать в блоке try-with-resources. Нужно бросить исключение, если работа с объектом типа счетчик была не в ресурсном try и/или ресурс остался открыт. Значение считать в ресурсе try, если при заведении животного заполнены все поля.
